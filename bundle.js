...
/***/ function(module, exports, __webpack_require__) {
	...
	var authEventsProfiles = __webpack_require__(8);
	var authEventsWorkouts = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileUpdateFailure = function profileUpdateFailure(error) {
	  console.error(error);
	};
	...
	var profileShowFailure = function profileShowFailure(error) {
	  console.error(error);
	};
	...
	module.exports = {
	  ...
	  profileShowFailure: profileShowFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  First name: <input type=\"text\" name=profile[first_name] value="
	    ...
	    + "><br>\n  Last name: <input type=\"text\" name=profile[last_name] value="
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateWorkout = function onCreateWorkout(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createNewWorkout(data).done(ui.createWorkoutSuccess).fail(ui.createWorkoutFailure);
	};

	var onSeeWorkouts = function onSeeWorkouts(event) {
	  event.preventDefault();
	  //  $(event.target).addClass('clicked');
	  api.seeWorkouts().done(ui.seeWorkoutsSuccess).fail(ui.seeWorkoutsFailure);
	};

	var onDeleteWorkout = function onDeleteWorkout(event) {
	  event.preventDefault();
	  var buttonId = $(event.target).attr('data-id');
	  api.deleteWorkout(buttonId).done(ui.deleteWorkoutSuccess).fail(ui.deleteWorkoutFailure);
	  onSeeWorkouts(event);
	};

	var onEditWorkout = function onEditWorkout(event) {
	  event.preventDefault();
	  var buttonId = $(event.target).find('.edit-workout').attr('data-id');
	  var data = getFormFields(event.target);
	  data.workout.id = buttonId;
	  data.workout.user_id = app.user.id;
	  api.editWorkout(data).done(ui.editWorkoutSuccess).fail();
	  api.seeWorkouts().done(ui.seeWorkoutsSuccess).fail(ui.seeWorkoutsFailure);
	};

	var onWorkoutsByDate = function onWorkoutsByDate(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createNewWorkout = function createNewWorkout(data) {
	  data.user_id = app.user.id;
	  return $.ajax({
	...
	var seeWorkouts = function seeWorkouts() {
	  return $.ajax({
	...
	var deleteWorkout = function deleteWorkout(buttonId) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(32);
	var app = __webpack_require__(6);
	var workoutTemplate = __webpack_require__(34);
	var getFormFields = __webpack_require__(4);
	...
	var deleteWorkoutFailure = function deleteWorkoutFailure(error) {
	  console.error(error);
	};

	var editWorkoutSuccess = function editWorkoutSuccess() {
	...
	var editWorkoutFailure = function editWorkoutFailure(error) {
	  console.error(error);
	};
	...
	var onDeleteWorkout = function onDeleteWorkout(event) {
	  event.preventDefault();
	  var buttonId = $(event.target).attr('data-id');
	  api.deleteWorkout(buttonId).done(deleteWorkoutSuccess).fail(deleteWorkoutFailure);
	};
	...
	var onEditWorkout = function onEditWorkout(event) {
	  ...
	  data.workout.id = buttonId;
	  data.workout.user_id = app.user.id;
	  api.editWorkout(data).done(editWorkoutSuccess).fail();
	};

	var seeWorkoutsSuccess = function seeWorkoutsSuccess(data) {
	  var workouts = data.user;
	  $('#view-workouts').html('');
	...
	var seeWorkoutsFailure = function seeWorkoutsFailure(error) {
	  console.error(error);
	};

	var findWorkoutDateSuccess = function findWorkoutDateSuccess(data) {
	...
	var findWorkoutDateFailure = function findWorkoutDateFailure(error) {
	  console.error(error);
	};
	...
	module.exports = {
	  ...
	  seeWorkoutsSuccess: seeWorkoutsSuccess,
	  seeWorkoutsFailure: seeWorkoutsFailure,
	  deleteWorkoutSuccess: deleteWorkoutSuccess,
	  deleteWorkoutFailure: deleteWorkoutFailure,
	  editWorkoutSuccess: editWorkoutSuccess,
	  editWorkoutFailure: editWorkoutFailure,
	  findWorkoutDateSuccess: findWorkoutDateSuccess,
	  findWorkoutDateFailure: findWorkoutDateFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <form class=\"workout-display\">\n    <fieldset class=\"form-group\">\n      <div class=\"row\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"workout","data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "      </div>\n      <div class=\"workoutEditDeleteButtons\">\n      <input type=\"submit\" class=\"delete-workout btn btn-default\" id=\""
	    + alias2(alias1((data && data.index), depth0))
	    + "\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" value=\"Delete\">\n      <input type=\"submit\" class=\"edit-workout btn btn-default\" id=\""
	    + alias2(alias1((data && data.index), depth0))
	    + "\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" value=\"Update\">\n    </div>\n    </fieldset>\n  </form>\n";
	  ...
	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.workouts : depth0), depth0),{"name":"workouts","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n\n<!-- this.attr(data id) -->\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0e1dfbecbcbc3040f8ac205382d62128.jpg";
